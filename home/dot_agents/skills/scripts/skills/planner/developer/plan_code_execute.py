    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR list-milestones",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR list-intents M-001",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-change \\",
        ...
        return {
            ...
            "actions": [
                ...
                "  2. Run with `bash`: cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan set-change ... --diff $'...'", 
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan validate --phase plan-code",
                "",
                "This validates:",
