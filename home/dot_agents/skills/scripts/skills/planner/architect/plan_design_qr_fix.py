    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-decision \\",
                "    --decision '<what was decided>' \\",
                "    --reasoning '<premise -> implication -> conclusion>'",
                "",
                "Missing code_intent:",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-intent \\",
        ...
        return {
            ...
            "actions": [
                ...
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan validate --phase plan-design --state-dir {state_dir}",
                "",
