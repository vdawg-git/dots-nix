    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  - Subdirectory AGENTS.md files in relevant areas",
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR <command>",
                "",
                "  Commands:",
                ...
                "",
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR batch '[",
                ...
                "",
                "1. Create diagram:",
                "   cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR set-diagram \\",
                "     --type architecture --scope overview --title 'System Overview'",
                "",
                "2. Add nodes (3-7 recommended, prevents visual overload):",
                "   cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR add-diagram-node \\",
                ...
                "   cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan --state-dir $STATE_DIR add-diagram-edge \\",
                ...
                "  cd ~/.agents/skills/scripts && python3 -m skills.planner.cli.plan validate --phase plan-design",
                "",
                "REFERENCE SCHEMA:",
                "",
                plan_json_schema,
