...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.2, bezier = "md3_accel", style = "popin 60%" })
hl.animation({ leaf = "border", enabled = false, speed = 0.4, bezier = "default" })
...
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 4, bezier = "md3_decel", style = "slidevert" })
